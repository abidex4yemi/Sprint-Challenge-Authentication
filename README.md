...
*`sessions:` http protocols are stateless therefore when user moves from one page to another we need a way to remember that user is already logged in. session enable us to track user moving from one page to another*

1. What does bcrypt do to help us store passwords in a secure manner.

*`Bcryptjs:` is an npm package that allows us to convert a plain text to hash value using its inbuilt hashing algorithm and a provided salt value*

1. What does bcrypt do to slow down attackers?

*`Salt:` by generating a random salt value*
